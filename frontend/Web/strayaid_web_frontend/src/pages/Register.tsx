...
function Register() {
  ...
  const validateForm = () => {
    ...
    } else if (form.password && form.password !== form.re_password) {
      ...
      <div className="register-left-image">
        <div className="image-overlay">
          <div className="inspirational-text">
            Join the mission.<br />Give every stray a safer tomorrow.
          </div>
        </div>
      </div>
      ...
      <div className="right-container">
        <div className="register-card">
          <div className="register-header">
            ...
            <p>Join StrayAid and help protect stray animals with your community.</p>
          </div>
